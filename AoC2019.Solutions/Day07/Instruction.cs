namespace AoC2019.Solutions.Day07
{
    ...
    public class Instruction
    {
        ...
        private static readonly Func<int[], int, int[], Queue<int>, List<int>, int>[] InstructionStrategies = new Func<int[], int, int[], Queue<int>, List<int>, int>[]
        {
            null,
        ...
        private readonly Func<int[], int, int[], Queue<int>, List<int>, int> operatorFunc;
        ...
        public int Execute(int[] memory, int pointer, Queue<int> inputs, List<int> outputs) => this.operatorFunc(memory, pointer, this.parameterModes, inputs, outputs);
